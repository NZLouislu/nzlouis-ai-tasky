...
export default function Chatbot({ onPageModification }: ChatbotProps = {}) {
  ...
  const generateMentionItems = (): MentionItem[] => {
    return [
      ...
      },
      {
        ...
        type: "heading",
        title: "Heading 1",
        content: "Main heading style",
      },
      {
        id: "heading-2",
        type: "heading",
        title: "Heading 2",
        content: "Sub heading style",
      },
      {
        id: "paragraph",
        type: "paragraph",
  ...
  const handlePageModification = async (
    modification: PageModification
  ): Promise<string> => {
            ...
            <div className="grid grid-cols-2 gap-2">
              {visionModels.slice(0, 4).map((model) => (
                <button
                  ...
                  onClick={() => {
                    alert(
                      `Switch to ${model.name}? Go to Settings to change models.`
                    );
