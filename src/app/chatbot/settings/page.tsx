...
const MODELS: Record<string, Array<{ id: string; name: string }>> = {
  ...
  openai: [
    ...
    { id: 'gpt-4o-mini', name: 'GPT-4o Mini - Affordable' },
    { id: 'o3-mini', name: 'O3 Mini - STEM' },
    { id: 'o1-mini', name: 'O1 Mini - Math/Code' },
  ],
  anthropic: [
    { id: 'claude-sonnet-4.5', name: 'Claude Sonnet 4.5 - Balanced' },
    { id: 'claude-4-opus', name: 'Claude 4 Opus - Powerful' },
    { id: 'claude-sonnet', name: 'Claude Sonnet - Versatile' },
  ...
  openrouter: [
    ...
    { id: 'deepseek/deepseek-chat-v3-0324:free', name: 'DeepSeek Chat V3 Free - Chat' },
