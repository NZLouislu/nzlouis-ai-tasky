...
-- Fix data type compatibility issues
-- ============================================

-- First check auth.uid() return type and existing table structure
-- View actual structure of user_profiles table
SELECT column_name, data_type, is_nullable
FROM information_schema.columns 
WHERE table_name = 'user_profiles' 
AND column_name = 'id';

-- View existing RLS policy implementation
SELECT schemaname, tablename, policyname, cmd, qual
FROM pg_policies 
WHERE tablename IN ('chat_sessions', 'blog_posts', 'user_profiles')
ORDER BY tablename, policyname;

-- ============================================
-- Create Stories table structure
-- ============================================
